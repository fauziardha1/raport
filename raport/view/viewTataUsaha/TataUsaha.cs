...
namespace raport
{
    public partial class TataUsaha : Form
    {
        public TataUsaha()
        {
            InitializeComponent();
        ...
        private void btnIdenSiswa_Click(object sender, EventArgs e)
        {
            IdenSiswa siswa = new IdenSiswa();
            AbrirFormEnPanel(siswa);
        }

        private void button2_Click(object sender, EventArgs e)
        {
            AbrirFormEnPanel(new KKM());
        }

        private void button3_Click(object sender, EventArgs e)
        {
            AbrirFormEnPanel(new KehadiranGuru());
        }
